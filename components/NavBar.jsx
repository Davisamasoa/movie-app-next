		...
		<header className="  text-amber-300 mb-10 flex justify-around flex-col items-center ">
			...
			<nav className="">
				<ul className="  text-white font-light tracking-wider flex gap-5 justify-center items-center ">
					<li className={!props.index ? null : "font-bold text-amber-200"}>
						<Link href={"/"}>Início</Link>
					</li>
					<li className={!props.filme ? null : "font-bold text-amber-200"}>
						<Link href={"/movies"}>Filmes</Link>
					</li>
					<li className={!props.serie ? null : "font-bold text-amber-200"}>
